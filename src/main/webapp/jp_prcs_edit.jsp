...
<body>
	...
	<div class="step_recruit" id="frm_hiring">
		...
		<form name="frm" action="post_edit_1.jsp" target="mypostEdit" method="post">
				...
				<div class="area_data type_txt">
					<ol class="list_process">
						...
						<input type="hidden" class="hiring_process_apply_cnt" name="hiring_process_apply_cnt_0" value="0">
							<div class="summary">
								<div class="tit_hiring">
									<input type="checkbox" name="notice_prcs_name" id="resume" class="inpTypo sizeL" value="서류전형" />서류전형
						...
						<li class="btn_step " id="hiring_detail_1" data-idx="1"><input
							...
							<div class="summary">
								<div class="tit_hiring" style="display: contents;">
									<input type="checkbox" name="notice_prcs_name" id="detail_1" class="inpTypo sizeL"  value="1차면접" >
									1차면접
								</div>
								<div class="txt_period"></div>
						...
						<li class="btn_step " id="hiring_detail_2" data-idx="2"><input
							...
							<div class="summary">
								<div class="tit_hiring">
									<input type="checkbox" name="notice_prcs_name" id="detail_2" class="inpTypo sizeL"  value="2차면접" >2차면접
								</div>
								<div class="txt_period"></div>
							...
							<div class="fulldata" id="option_div3">
								<div class="optional_item" id="option_div3">
									...
									<dl style="display: block;">
										...
										<dd>
											<span class="inpRdo sizeM">
												<input type="radio" name="notice_prcs_type" id="process_type_cd1_2" value="서류">
												<label class="lbl" for="process_type_cd1_2">서류</label></span>
											<span class="inpRdo sizeM">
												<input type="radio" name="notice_prcs_type" id="process_type_cd2_2" value="면접">
												<label class="lbl" for="process_type_cd2_2">면접</label></span>
											<span class="inpRdo sizeM">
												<input type="radio" name="notice_prcs_type" id="process_type_cd3_2" value="인적성">
												<label class="lbl" for="process_type_cd3_2">인적성</label></span>
											<span class="inpRdo sizeM">
												<input type="radio" name="notice_prcs_type" id="process_type_cd4_2" value="레퍼런스">
												<label class="lbl" for="process_type_cd4_2">레퍼런스</label></span>
											<span class="inpRdo sizeM">
												<input type="radio" name="process_type_cd_2" id="process_type_cd5_2" value="기타">
												<label class="lbl" for="process_type_cd5_2">기타</label></span>
											<span class="inpRdo sizeM" style="display: none;">
												<input type="radio" name="process_type_cd_2" id="process_type_cd6_2" value="합격">
												<label class="lbl" for="process_type_cd6_2">합격</label></span>
										</dd>
									</dl>
									<dl class="type_input">
										<dt>
						...
						<li class="btn_step " id="hiring_detail_3" data-idx="3"><input
							...
							<div class="summary">
								<div class="tit_hiring">
									<input type="checkbox" name="notice_prcs_name" id="final" class="inpTypo sizeL" value="최종합격" >최종합격
								</div>
								<div class="txt_period"></div>
