...
<body>
	<div id="section_contents" class="cont_top" style="float: left;">
		...
		<div class="wrap_recomm company" style="height: 425px;">
			<div class="tit_recomm">
			...
			<div class="info_recomm">
				<ul class="list_recomm">
					...
					<li>
						...
						<div class="wrap_other_interview" data-gtm-vis-recent-on-screen-6226168_981="71" data-gtm-vis-first-on-screen-6226168_981="71"
							data-gtm-vis-total-visible-time-6226168_981="100" data-gtm-vis-has-fired-6226168_981="1">
							<div class="inner_other other2 ">
								<!-- <strong class="tit">회원가입 혜택 놓치지 마세요!</strong>
								<p class="txt">
									S-포인트 1만점 / 첫 결제시 100% 페이백<br>30% 할인쿠폰 / 첫 공고 효과 증폭
								</p>
								<a href="/zf_user/member/registration/join?ut=c" class="btn_other_link" title="회원가입하고 혜택 받으러 가기">가입하러 가기</a> -->
							</div>
							<div class="inner_other other3 on">
								...
								<a href="/zf_user/cms/labor-counsel/list" target="_blank" class="btn_other_link"
									onmousedown="try{n_trackEvent('main', 'comp_banner_click' , 'labor_counsel');}catch(e){}"
									title="전문 노무사에게 무료 법률상담 하러 가기">전문 노무사 <strong>무료</strong> 법률 상담 </a> -->
							</div>
						</div>
					</li>
...
<!-- 
			...
			<form action="/zf_user/auth/logout" method="get">
				...
				<fieldset>
					...
					<div class="cont_member">
						<span class="name_member"><strong>InOut</strong>님</span>
		...
		<div class="wrap_more">
			...
			<div class="info_more info_thema recruit" style="display: none">
				...
				<ul class="list_more">
					<li class="thema4">
						<a href="/zf_user/jobs/list/curation?curation_seq=190" class="link_thema" onmousedown="trackEvent('list')">
							<span class="tags"><strong class="txt_tags">#외국계기업</strong></span>
							<span class="txt_thema">연봉 5,000 이상 외국계</span></a>
					</li>
					<li class="thema14">
						<a href="/zf_user/jobs/list/curation?curation_seq=245" class="link_thema" onmousedown="trackEvent('list')">
							<span class="tags"><strong class="txt_tags">#특별채용</strong></span>
							<span class="txt_thema">사람인이 추천하는 HOT공고</span></a>
					</li>
				</ul>
				<!-- <a href="/zf_user/curation" class="link_more" onmousedown="trackEvent('more')">더보기</a> -->
			</div>
			<!-- 큐레이션 end -->
			...
			<div class="info_more info_thema hr_magazine" style="">
				...
				<!-- <a href="/zf_user/hr-magazine/list" target="_blank" class="link_more has_new">더보기</a> -->
			</div>
			<!-- HR 매거진 end -->
							...
							<div class="col-md-12 ftco-animate">
								<div class="job-post-item p-4 d-block d-lg-flex align-items-center">
									<div class="one-third mb-4 mb-md-0">
										...
										<div class="job-post-item-body d-block d-md-flex">
											<div class="mr-3">
												<span class="icon-layers"></span> <a href="#">New York Times</a>
											</div>
											<div>
