...
<script type="text/javascript">
	...
	$(function(){
		...
		$('#btn_add_want').click(function(){
			
			var tdno=  $('#common_table .mj:first').clone();
			var itemList = $("#common_table .mj:last").attr("id").replace("mj", "");
			tdno.attr("id", "mj"+(parseInt(itemList)+1));
			
			$('#common_table').append(tdno);
...
.pc_recruit_template .tbl_template.txt_type .a-template {
	height: 105px;
}
																	...
																	<tr>
																		<td>
																			<div class="btns">
																				...
																				<button type="button" title="수정하기" class="spr_jview btn_jview btn_modify" style="margin: 0 auto; width: 100%; border: none;">
																					<span>모집분야 수정</span></button></a>
																				<a href="jp_want_add.jsp" target="_blank">
																				<button type="button" title="추가하기" class="spr_jview btn_jview btn_modify" style="margin: 0 auto; width: 100%; border: none;" id="btn_add_want">
																						...
																						<tr class="display_hiring_process_list">
																							<td>
																								<div class="btns">
																									...
																									<button type="button" title="추가하기" class="spr_jview btn_jview btn_modify" style="margin: 0 auto; width: 100%; border: none;">
