																									...
																									<tbody>
																										<tr>
																											...
																											<td id="recruit_name">ㆍ모집분야명 :
																												<%= request.getParameter("notice_want_name") %><font color="#08ffa7"></font>
																											</td>
																										</tr>
																										<tr>
																											<td id="career_no">ㆍ경력 여부 : 
																												<%= request.getParameter("car") %><%=request.getParameter("newb") %><font color="#2969a8"></font>
																											</td>
																										</tr>
																										<tr>
																											<td id="respons">ㆍ담당업무 : 
																												<%= request.getParameter("notice_want_task") %><font color="#2969a8"></font>
																											</td>
																										</tr>
																										<tr>
																											<td id="dept">ㆍ근무부서 : 
																												<%= request.getParameter("notice_want_dept") %><font color="#2969a8"></font>
																											</td>
																										</tr>
																										<tr>
																								...
																								<ol class="step_template_type step_template_type2" d="template_step_hiring_process_list">
																									<li><div class="cont_step">
																											<div class="inner">
																												...
																												<span class="txt_step">
																													<%=request.getParameter("notice_prcs_name") %>
																												</span>
																											</div>
																										</div></li>
																									<li><div class="cont_step">
																											<div class="inner">
																												...
																												<span class="txt_step"><%= request.getParameter("notice_prcs_type") %></span>
																											</div>
																										</div></li>
																									<li><div class="cont_step">
																										<div class="inner">
																						...
																						<tr>
																							<td>
																								...
																								<div class="wrap_list_template">
																									<table class="tbl_list list_template">
																										<tbody>
																											<tr>
																												<td>
																													<span class="tit" id="template_insa_q"><%= request.getParameter("notice_qna_q") %></span>
																													<span class="colon">:</span>
																													<span class="txt" id="template_insa_a"><%= request.getParameter("notice_qna_a") %></span>
																												</td>
																											</tr>
																											<tr>
																												<td>
										...
										<div class="cont box">
											<div class="status" style="width: 800px;">
												...
												<dl class="info_period">
													...
													<dt class="end" style="margin-left: 150px; margin-top: 0;">마감일</dt>
													<dd style="margin-top: 0;">2020.07.26 23:59</dd>
												</dl>
												<button class="sri_btn_lg for_btn_event"
